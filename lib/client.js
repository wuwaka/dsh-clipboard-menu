...
function focusBack() {
  var el = activeEl;
  if (el && el.nodeType === 1 && typeof el.focus === "function") {
    try {
...
function onContextMenu(ev) {
  ...
  // Own the editable fields only. Every other context menu in the app (JSON
  // copy buttons, sidebar previews, plugin menus) keeps working untouched.
